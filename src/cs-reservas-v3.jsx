...
var HOTELES_CATALOG = {
  "Cancun":[
    {id:"H101",nombre:"Krystal Grand Cancun Resort",cat:"5",fee:75,precioNoche:120,ageMin:25,ageMax:65,marital:["Soltero Hombre","Soltera Mujer","Casado(a)","Union Libre"],tipos:["qc"],habs:[{id:"a",nombre:"Superior",base:true,up:0},{id:"b",nombre:"Deluxe",base:false,up:40},{id:"c",nombre:"Deluxe Oceano King",base:false,up:75},{id:"d",nombre:"Suite Junior",base:false,up:130}],regs:["Solo habitacion","Desayuno incluido","Todo incluido"],temps:[{id:"t1",nombre:"Semana Santa",inicio:"2026-03-28",fin:"2026-04-05",surcharge:60}]},
    {id:"H102",nombre:"Hotel Emporio Cancun",cat:"4",fee:50,precioNoche:90,ageMin:25,ageMax:99,marital:["Soltero Hombre","Soltera Mujer","Casado(a)","Union Libre"],tipos:["qc","nq"],habs:[{id:"a",nombre:"Estandar",base:true,up:0},{id:"b",nombre:"Superior",base:false,up:30},{id:"c",nombre:"Deluxe",base:false,up:55}],regs:["Solo habitacion","Desayuno incluido","Todo incluido"],temps:[]},
    {id:"H103",nombre:"Live Aqua Beach Resort",cat:"5",fee:100,precioNoche:180,ageMin:30,ageMax:60,marital:["Casado(a)","Union Libre"],tipos:["qc"],habs:[{id:"a",nombre:"Aqua Room",base:true,up:0},{id:"b",nombre:"Aqua Suite",base:false,up:150}],regs:["Todo incluido"],temps:[]},
  ],
  "Los Cabos":[
    {id:"H201",nombre:"Riu Palace Cabo San Lucas",cat:"5",fee:80,precioNoche:140,ageMin:36,ageMax:99,marital:["Casado(a)","Union Libre"],tipos:["qc"],habs:[{id:"a",nombre:"Deluxe",base:true,up:0},{id:"b",nombre:"Junior Suite",base:false,up:100},{id:"c",nombre:"Suite Premium",base:false,up:200}],regs:["Todo incluido"],temps:[]},
    {id:"H202",nombre:"Melia Cabo Real Beach Golf",cat:"5",fee:65,precioNoche:110,ageMin:25,ageMax:99,marital:["Casado(a)","Union Libre"],tipos:["qc","nq"],habs:[{id:"a",nombre:"Superior Garden View",base:true,up:0},{id:"b",nombre:"Deluxe Sea View",base:false,up:60}],regs:["Solo habitacion","Desayuno incluido","Todo incluido"],temps:[]},
  ],
  "Riviera Maya":[
    {id:"H301",nombre:"Iberostar Paraiso Lindo",cat:"5",fee:85,precioNoche:150,ageMin:25,ageMax:60,marital:["Casado(a)","Union Libre"],tipos:["qc"],habs:[{id:"a",nombre:"Superior",base:true,up:0},{id:"b",nombre:"Premium",base:false,up:80},{id:"c",nombre:"Suite Oceanfront",base:false,up:180}],regs:["Todo incluido"],temps:[]},
    {id:"H302",nombre:"Grand Palladium Riviera Resort",cat:"5",fee:70,precioNoche:120,ageMin:25,ageMax:70,marital:["Soltero Hombre","Soltera Mujer","Casado(a)","Union Libre"],tipos:["qc","nq"],habs:[{id:"a",nombre:"Junior Suite",base:true,up:0},{id:"b",nombre:"Suite",base:false,up:90}],regs:["Todo incluido"],temps:[]},
  ],
  "Puerto Vallarta":[
    {id:"H401",nombre:"Marriott Puerto Vallarta Resort",cat:"5",fee:70,precioNoche:115,ageMin:25,ageMax:60,marital:["Soltero Hombre","Soltera Mujer","Casado(a)","Union Libre"],tipos:["qc","nq"],habs:[{id:"a",nombre:"Deluxe",base:true,up:0},{id:"b",nombre:"Deluxe Marina View",base:false,up:60},{id:"c",nombre:"Suite Junior",base:false,up:140}],regs:["Solo habitacion","Desayuno incluido","Todo incluido"],temps:[]},
  ],
  "Huatulco":[
    {id:"H501",nombre:"Dreams Huatulco Resort Spa",cat:"5",fee:60,precioNoche:100,ageMin:25,ageMax:65,marital:["Casado(a)","Union Libre"],tipos:["qc"],habs:[{id:"a",nombre:"Deluxe",base:true,up:0},{id:"b",nombre:"Preferred Club",base:false,up:90}],regs:["Todo incluido"],temps:[]},
    {id:"H502",nombre:"Barcelo Huatulco",cat:"4",fee:50,precioNoche:80,ageMin:25,ageMax:99,marital:["Soltero Hombre","Soltera Mujer","Casado(a)","Union Libre"],tipos:["qc","nq"],habs:[{id:"a",nombre:"Estandar",base:true,up:0},{id:"b",nombre:"Superior",base:false,up:40}],regs:["Todo incluido"],temps:[]},
  ],
  "Las Vegas":[
    {id:"H601",nombre:"MGM Grand",cat:"4",fee:60,precioNoche:95,ageMin:21,ageMax:99,marital:["Soltero Hombre","Soltera Mujer","Casado(a)","Union Libre"],tipos:["qc","nq"],habs:[{id:"a",nombre:"Deluxe",base:true,up:0},{id:"b",nombre:"Strip View",base:false,up:50}],regs:["Solo habitacion"],temps:[]},
    {id:"H602",nombre:"Bellagio Hotel Casino",cat:"5",fee:90,precioNoche:160,ageMin:25,ageMax:70,marital:["Casado(a)","Union Libre"],tipos:["qc"],habs:[{id:"a",nombre:"Deluxe",base:true,up:0},{id:"b",nombre:"Fountain View",base:false,up:80}],regs:["Solo habitacion"],temps:[]},
  ],
  "Orlando":[
    {id:"H701",nombre:"Walt Disney World Swan",cat:"4",fee:70,precioNoche:110,ageMin:25,ageMax:99,marital:["Soltero Hombre","Soltera Mujer","Casado(a)","Union Libre"],tipos:["qc","nq"],habs:[{id:"a",nombre:"Standard",base:true,up:0},{id:"b",nombre:"Lake View",base:false,up:50}],regs:["Solo habitacion","Desayuno incluido"],temps:[]},
  ],
};
        ...
        {paso === 1 && (
          <div>
            ...
            <div style={S.g2}>
              ...
              <div><label style={S.label}>Estado civil</label><select style={S.sel} value={estadoCivil} onChange={function(e){ setEstadoCivil(e.target.value); }}><option value="">-- Seleccionar --</option><option value="Soltero Hombre">Soltero Hombre</option><option value="Soltera Mujer">Soltera Mujer</option><option value="Casado(a)">Casado(a)</option><option value="Union Libre">Union Libre</option></select></div>
