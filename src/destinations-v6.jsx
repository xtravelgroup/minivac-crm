...
const SEED = [
  {
    id:"D01", name:"Cancún", state:"Quintana Roo", icon:"🏖️",
    region:"internacional",
    category:"Premium", description:"La Zona Hotelera más famosa de México con playas de arena blanca y mar turquesa.", active:true,
    // Regalos siempre incluidos en ESTE destino (todos los compradores los ven)
    includedGifts: ["IG01","IG04","IG05"],
    qc: {
      nights: 5,
      hotels: [
        { id:"H001", name:"Grand Oasis Palm",       plan:"Todo Incluido",         capacity:["Parejas","Familias"], ageMin:25, ageMax:60, marital:["Casado","Unión libre","Soltero"], active:true,
          amenities:["Piscina","Playa privada","Spa","Shows nocturnos","Bar swim-up"], hotelGifts:[] },
        { id:"H002", name:"Hyatt Zilara Cancún",    plan:"Todo Incluido Premium", capacity:["Parejas","Solo adultos"], ageMin:18, ageMax:99, marital:["Casado","Unión libre","Soltero","Divorciado"], active:true,
          amenities:["Playa privada","Spa","Butler service","Restaurantes múltiples","Bar swim-up"], hotelGifts:["Cena romántica de bienvenida","Acceso ilimitado al Spa (1 día)"] },
        { id:"H003", name:"Moon Palace Golf & Spa", plan:"Todo Incluido",         capacity:["Familias","Grupos"], ageMin:25, ageMax:65, marital:["Casado","Unión libre","Divorciado"], active:true,
          amenities:["Golf","Piscina","Spa","Kids club","Casino"], hotelGifts:["Crédito de golf $50"] },
      ],
      gifts: { enabled:true, maxChoices:1, items:[
        { id:"G001", icon:"🗺️", name:"Tour a Chichén Itzá",   description:"Excursión de día completo con guía", active:true },
        { id:"G002", icon:"🤿", name:"Tour snorkel Isla Mujeres", description:"Recorrido en catamarán con snorkel", active:true },
        { id:"G004", icon:"💳", name:"Gift Card $75 USD",      description:"Canjeable en el resort", active:true },
      ]},
    },
    nq: {
      enabled: true, nights: 4, label: "Cancún Esencial",
      hotels: [
        { id:"N001", name:"Crown Paradise Club",  plan:"Todo Incluido", capacity:["Parejas","Familias","Grupos"], active:true, amenities:["Piscina","Playa privada"], hotelGifts:[] },
        { id:"N002", name:"Krystal Cancún",        plan:"Todo Incluido", capacity:["Parejas","Familias"], active:true, amenities:["Piscina","Spa"], hotelGifts:[] },
      ],
    },
  },
  {
    id:"D02", name:"Los Cabos", state:"Baja California Sur", icon:"🌵",
    region:"internacional",
    category:"Ultra Premium", description:"El Arco icónico, desierto y mar. Destino de lujo en el extremo de Baja California.", active:true,
    includedGifts: ["IG01","IG05"],
    qc: {
      nights: 4,
      hotels: [
        { id:"H005", name:"Marquis Los Cabos",  plan:"Todo Incluido Premium", capacity:["Parejas"], ageMin:36, ageMax:99, marital:["Casado"], active:true,
          amenities:["Playa privada","Spa","Butler service","Golf","Restaurantes múltiples"], hotelGifts:["Botella de champagne al llegar","Masaje de bienvenida (30 min)"] },
        { id:"H006", name:"One&Only Palmilla",  plan:"Solo Habitación",       capacity:["Parejas","Grupos"], ageMin:30, ageMax:99, marital:["Casado","Unión libre"], active:true,
          amenities:["Playa privada","Golf","Spa","Butler service"], hotelGifts:[] },
      ],
      gifts: { enabled:true, maxChoices:1, items:[
        { id:"G006", icon:"🍽️", name:"Cena romántica en la playa",  description:"Cena privada para dos frente al mar", active:true },
        { id:"G007", icon:"⛵", name:"Tour en lancha al Arco",       description:"Tour en lancha al Arco de Cabo", active:true },
        { id:"G008", icon:"💳", name:"Gift Card $75 USD",            description:"Canjeable en el resort", active:true },
      ]},
    },
    nq: { enabled:false, nights:3, label:"", hotels:[] },
  },
  {
    id:"D03", name:"Riviera Maya", state:"Quintana Roo", icon:"🌴",
    region:"internacional",
    category:"Familiar", description:"Cenotes, ruinas mayas y playas paradisíacas.", active:true,
    includedGifts: ["IG01","IG05","IG07"],
    qc: {
      nights: 6,
      hotels: [
        { id:"H007", name:"Iberostar Paraíso",       plan:"Todo Incluido",         capacity:["Familias","Grupos"], ageMin:25, ageMax:55, marital:["Casado","Unión libre","Divorciado"], active:true,
          amenities:["Piscina","Playa privada","Kids club","Shows nocturnos","Restaurantes múltiples"], hotelGifts:[] },
        { id:"H008", name:"Grand Velas Riviera Maya", plan:"Todo Incluido Premium", capacity:["Parejas","Familias"], ageMin:28, ageMax:60, marital:["Casado","Unión libre"], active:true,
          amenities:["Butler service","Spa","Playa privada","Restaurantes múltiples","Wi-Fi incluido"], hotelGifts:["Acceso ilimitado al Spa","Clases de cocina mexicana"] },
      ],
      gifts: { enabled:true, maxChoices:1, items:[
        { id:"G009", icon:"🏛️", name:"Tour Tulum + Cenote",          description:"Ruinas de Tulum y cenote natural", active:true },
        { id:"G010", icon:"🤿", name:"Snorkel en arrecife",           description:"Tour de snorkel en el arrecife", active:true },
        { id:"G011", icon:"💳", name:"Gift Card $75 USD",             description:"Canjeable en el resort", active:true },
      ]},
    },
    nq: {
      enabled: true, nights: 4, label: "Riviera Maya Básico",
      hotels: [
        { id:"N003", name:"Bahia Principe Akumal", plan:"Todo Incluido", capacity:["Familias","Parejas","Grupos"], active:true, amenities:["Piscina","Playa privada","Kids club"], hotelGifts:[] },
        { id:"N004", name:"Grand Bahia Principe",  plan:"Todo Incluido", capacity:["Familias","Grupos"], active:true, amenities:["Piscina","Shows nocturnos"], hotelGifts:[] },
      ],
    },
  },
  {
    id:"D04", name:"Las Vegas", state:"Nevada", icon:"🎰",
    region:"nacional",
    category:"Premium", description:"La capital del entretenimiento. Shows, casinos, gastronomía de clase mundial.", active:true,
    includedGifts: ["IG01","IG09"],
    qc: {
      nights: 3,
      hotels: [
        { id:"H020", name:"MGM Grand", plan:"Solo Habitación", capacity:["Parejas","Grupos","Solo adultos"], ageMin:21, ageMax:99, marital:["Casado","Unión libre","Soltero","Divorciado"], active:true,
          amenities:["Casino","Piscina","Spa","Shows nocturnos","Restaurantes múltiples","Gimnasio"], hotelGifts:["Crédito de casino $50 USD"] },
        { id:"H021", name:"Bellagio", plan:"Solo Habitación", capacity:["Parejas","Solo adultos"], ageMin:21, ageMax:99, marital:["Casado","Unión libre","Soltero"], active:true,
          amenities:["Casino","Spa","Restaurantes múltiples","Shows nocturnos"], hotelGifts:["Crédito de casino $75 USD","Acceso al spa (1 sesión)"] },
      ],
      gifts: { enabled:true, maxChoices:1, items:[
        { id:"G020", icon:"🎰", name:"$50 crédito casino",            description:"Crédito de $50 USD en el casino del hotel", active:true },
        { id:"G021", icon:"🎭", name:"Show ticket (2 personas)",      description:"Entradas a show seleccionado en el Strip", active:true },
        { id:"G022", icon:"💳", name:"Gift Card $100 USD",             description:"Canjeable en el resort o The Strip", active:true },
      ]},
    },
    nq: { enabled:false, nights:3, label:"", hotels:[] },
  },
  {
    id:"D05", name:"Orlando", state:"Florida", icon:"🎡",
    region:"nacional",
    category:"Familiar", description:"El reino de la magia. Disney, Universal, parques acuáticos y más.", active:true,
    includedGifts: ["IG01","IG06"],
    qc: {
      nights: 4,
      hotels: [
        { id:"H022", name:"Disney's Grand Floridian", plan:"Solo Habitación", capacity:["Familias","Parejas"], ageMin:18, ageMax:99, marital:["Casado","Unión libre","Divorciado","Soltero"], active:true,
          amenities:["Piscina","Acceso a parque temático","Kids club","Restaurantes múltiples","Wi-Fi incluido"], hotelGifts:["Acceso al parque Disney (1 día)"] },
        { id:"H023", name:"Universal's Cabana Bay",   plan:"Desayuno incluido", capacity:["Familias","Grupos"], ageMin:18, ageMax:99, marital:["Casado","Unión libre","Soltero","Divorciado"], active:true,
          amenities:["Piscina","Acceso a parque temático","Wi-Fi incluido"], hotelGifts:[] },
      ],
      gifts: { enabled:true, maxChoices:1, items:[
        { id:"G023", icon:"🎁", name:"Gift Card $100 USD",            description:"Gift card canjeable en el destino", active:true },
        { id:"G024", icon:"🌊", name:"2 entradas parque de agua",     description:"Entradas a Volcano Bay o similar", active:true },
        { id:"G025", icon:"🎢", name:"2 entradas Disney (1 día)",     description:"Entradas a parque Disney seleccionado", active:true },
      ]},
    },
    nq: { enabled:false, nights:3, label:"", hotels:[] },
  },
  {
    id:"D06", name:"Puerto Vallarta", state:"Jalisco", icon:"🌺",
    region:"internacional",
    category:"Romance", description:"El malecón y las playas del Pacífico. Ambiente romántico.", active:true,
    includedGifts: ["IG01","IG07"],
    qc: {
      nights: 4,
      hotels: [
        { id:"H010", name:"Secrets Vallarta Bay", plan:"Todo Incluido Premium", capacity:["Parejas","Solo adultos"], ageMin:25, ageMax:65, marital:["Casado","Unión libre","Soltero"], active:true,
          amenities:["Playa privada","Spa","Bar swim-up","Restaurantes múltiples","Shows nocturnos"], hotelGifts:["Cena en la playa (para dos)"] },
        { id:"H011", name:"Garza Blanca Resort",  plan:"Solo Habitación",       capacity:["Parejas"], ageMin:30, ageMax:70, marital:["Casado","Unión libre"], active:true,
          amenities:["Playa privada","Spa","Golf","Butler service"], hotelGifts:[] },
      ],
      gifts: { enabled:true, maxChoices:1, items:[
        { id:"G030", icon:"⛵", name:"Tour en barco Bahía Banderas",  description:"Recorrido por la bahía con snorkel", active:true },
        { id:"G031", icon:"💳", name:"Gift Card $50 USD",             description:"Canjeable en el resort", active:true },
      ]},
    },
    nq: { enabled:false, nights:3, label:"", hotels:[] },
  },
  {
    id:"D07", name:"Huatulco", state:"Oaxaca", icon:"⛵",
    region:"internacional",
    category:"Boutique", description:"9 bahías de aguas cristalinas en la costa oaxaqueña.", active:true,
    includedGifts: ["IG01","IG06"],
    qc: {
      nights: 5,
      hotels: [
        { id:"H012", name:"Las Brisas Huatulco",  plan:"Desayuno incluido", capacity:["Parejas"], ageMin:30, ageMax:65, marital:["Casado","Unión libre"], active:true,
          amenities:["Playa privada","Piscina","Spa","Golf"], hotelGifts:[] },
        { id:"H013", name:"Camino Real Zaashila",  plan:"Solo Habitación",  capacity:["Parejas","Familias"], ageMin:25, ageMax:70, marital:["Casado","Unión libre","Divorciado"], active:true,
          amenities:["Piscina","Playa privada","Restaurantes múltiples"], hotelGifts:[] },
      ],
      gifts: { enabled:true, maxChoices:1, items:[
        { id:"G013", icon:"🤿", name:"Tour en catamarán bahías",     description:"Recorrido por las 9 bahías con snorkel", active:true },
        { id:"G014", icon:"💳", name:"Gift Card $50 USD",            description:"Canjeable en el resort", active:true },
      ]},
    },
    nq: {
      enabled: true, nights: 3, label: "Huatulco Express",
      hotels: [
        { id:"N005", name:"Barceló Huatulco", plan:"Todo Incluido", capacity:["Parejas","Familias","Grupos"], active:true, amenities:["Piscina","Playa privada"], hotelGifts:[] },
      ],
    },
  },
];
