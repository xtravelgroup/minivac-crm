...
const ESTADO_CIVIL_OPTIONS = ["Casado","Union libre","Soltero","Divorciado","Viudo"];
...
const VERIF_RESULTS = {
  venta:                 { label:"Venta",             color:"#4ade80", bg:"rgba(74,222,128,0.08)",   border:"rgba(74,222,128,0.3)"   },
  venta_pendiente:       { label:"Venta Pendiente",   color:"#fbbf24", bg:"rgba(251,191,36,0.08)",  border:"rgba(251,191,36,0.3)"   },
  tarjeta_rechazada:     { label:"Tarjeta Rechazada", color:"#f87171", bg:"rgba(248,113,113,0.08)", border:"rgba(248,113,113,0.3)"  },
  cliente_no_interesado: { label:"No Interesado",     color:"#94a3b8", bg:"rgba(148,163,184,0.08)", border:"rgba(148,163,184,0.3)"  },
};
...
const SEED = [
  {
    ...
    exp:{
      tFirstName:"Miguel", tLastName:"Torres", tFechaNac:"1982-05-14", tPhone:"305-1234-04", tEmail:"miguel@email.com", tEstadoCivil:"Casado",
      hasPartner:true, pFirstName:"Elena", pLastName:"Torres", pFechaNac:"1985-03-22", pPhone:"305-1234-05",
  ...
  },
  {
    ...
    exp:{
      tFirstName:"Patricia", tLastName:"Sanchez", tFechaNac:"1989-11-30", tPhone:"305-9876-07", tEmail:"paty.sanchez@gmail.com", tEstadoCivil:"Casado",
      hasPartner:true, pFirstName:"Rodrigo", pLastName:"Sanchez", pFechaNac:"1986-07-08", pPhone:"305-9876-08",
  ...
  },
  {
    ...
    exp:{
      tFirstName:"Fernando", tLastName:"Reyes", tFechaNac:"1969-02-19", tPhone:"305-5544-08", tEmail:"freyes@hotmail.com", tEstadoCivil:"Divorciado",
...
const S = {
  ...
  topbar:  { background:"rgba(10,14,26,0.97)", backdropFilter:"blur(16px)", borderBottom:"1px solid rgba(255,255,255,0.06)", padding:"14px 28px", display:"flex", alignItems:"center", gap:"14px", position:"sticky", top:0, zIndex:100 },
  card:    { background:"#f9fafb", border:"1px solid rgba(255,255,255,0.07)", borderRadius:"14px", padding:"20px", marginBottom:"14px" },
  label:   { fontSize:"11px", color:"#64748b", marginBottom:"3px", fontWeight:"500" },
  value:   { fontSize:"14px", color:"#e2e8f0", fontWeight:"500" },
  sTitle:  { fontSize:"10px", fontWeight:"700", color:"#475569", letterSpacing:"0.12em", textTransform:"uppercase", marginBottom:"12px" },
  divider: { height:"1px", background:"#f4f5f7", margin:"14px 0" },
  input:   { width:"100%", background:"#f6f7f9", border:"1px solid rgba(255,255,255,0.12)", borderRadius:"8px", padding:"9px 12px", color:"#e2e8f0", fontSize:"13px", outline:"none", boxSizing:"border-box", fontFamily:"inherit" },
  textarea:{ width:"100%", background:"#f6f7f9", border:"1px solid rgba(255,255,255,0.12)", borderRadius:"8px", padding:"9px 12px", color:"#e2e8f0", fontSize:"13px", outline:"none", resize:"vertical", minHeight:"72px", boxSizing:"border-box", fontFamily:"inherit" },
  select:  { width:"100%", background:"rgba(15,18,30,0.95)", border:"1px solid rgba(255,255,255,0.12)", borderRadius:"8px", padding:"9px 12px", color:"#e2e8f0", fontSize:"13px", outline:"none", cursor:"pointer", fontFamily:"inherit", boxSizing:"border-box" },
  ...
  modalBox:{ background:"#ffffff", border:"1px solid rgba(255,255,255,0.1)", borderRadius:"18px", padding:"28px", maxWidth:"600px", width:"100%", maxHeight:"90vh", overflowY:"auto" },
  ...
  btn:     (v) => {
    const m = {
      ...
      ghost:  { bg:"#f6f7f9",   color:"#94a3b8", border:"#eceff3"},
  ...
  return (
    <div style={S.modal} onClick={onClose}>
      <div style={S.modalBox} onClick={e => e.stopPropagation()}>
        <div style={{ fontSize:"18px", fontWeight:"700", color:"#f1f5f9", marginBottom:"4px" }}>Editar Expediente</div>
        <div style={{ fontSize:"13px", color:"#64748b", marginBottom:"20px" }}>Cambios registrados por el verificador</div>
        ...
        <div style={{ marginBottom:"16px" }}>
          ...
          <div style={S.g3}>
            ...
            <div>
              ...
              {d.tFechaNac && <div style={{ fontSize:"11px", color:"#4ade80", marginTop:"3px", fontWeight:"600" }}>Edad: {edadLabel(d.tFechaNac)}</div>}
            </div>
            <div>
        ...
        <div style={{ marginBottom:"16px" }}>
          <div style={{ display:"flex", alignItems:"center", gap:"10px", marginBottom:"10px" }}>
            ...
            <label style={{ display:"flex", alignItems:"center", gap:"6px", cursor:"pointer", marginBottom:"12px" }}>
              ...
              <span style={{ fontSize:"12px", color:"#64748b" }}>Incluir</span>
            </label>
          </div>
          {d.hasPartner && (
            <div style={S.g3}>
              ...
              <div>
                ...
                {d.pFechaNac && <div style={{ fontSize:"11px", color:"#4ade80", marginTop:"3px", fontWeight:"600" }}>Edad: {edadLabel(d.pFechaNac)}</div>}
              </div>
            ...
            return (
              <div key={i} style={{ padding:"12px 14px", borderRadius:"10px", background:"rgba(99,102,241,0.06)", border:"1px solid rgba(99,102,241,0.18)", marginBottom:"8px" }}>
                <div style={{ display:"flex", alignItems:"center", gap:"8px", marginBottom:"8px" }}>
                  ...
                  <button onClick={() => removeDest(i)} style={{ background:"rgba(248,113,113,0.1)", border:"1px solid rgba(248,113,113,0.2)", color:"#f87171", borderRadius:"7px", padding:"4px 8px", cursor:"pointer", fontSize:"14px" }}>x</button>
                </div>
                {cat && (
                  <div style={{ paddingTop:"8px", borderTop:"1px solid rgba(255,255,255,0.06)" }}>
                    <div style={{ fontSize:"10px", color:"#fbbf24", fontWeight:"700", marginBottom:"5px" }}>Regalo (elige 1)</div>
                    <div style={{ display:"flex", gap:"5px", flexWrap:"wrap" }}>
                      <div onClick={() => setRegalo(i,null)} style={{ padding:"3px 9px", borderRadius:"7px", cursor:"pointer", fontSize:"11px", background:!dest.regalo?"#eceff3":"#f9fafb", border:"1px solid " + (!dest.regalo?"rgba(255,255,255,0.3)":"#f0f1f4"), color:!dest.regalo?"#f1f5f9":"#475569" }}>Sin regalo</div>
                      {cat.regalos.map(r => {
                        const sel = dest.regalo && dest.regalo.id === r.id;
                        return (
                          <div key={r.id} onClick={() => setRegalo(i,r)} style={{ padding:"3px 9px", borderRadius:"7px", cursor:"pointer", fontSize:"11px", background:sel?"rgba(251,191,36,0.1)":"#f9fafb", border:"2px solid " + (sel?"rgba(251,191,36,0.5)":"#f0f1f4"), color:sel?"#fbbf24":"#64748b", fontWeight:sel?"700":"400" }}>
                            {r.label}
                          </div>
                        );
                      })}
        ...
        <div style={{ marginBottom:"16px" }}>
          ...
          <div style={S.g3}>
            ...
            <div><div style={S.label}>Saldo</div><div style={{ fontSize:"15px", fontWeight:"800", color:"#fbbf24", padding:"9px 0" }}>{fmtUSD(saldo)}</div></div>
          </div>
        </div>
        ...
        <div style={{ display:"flex", gap:"10px" }}>
          ...
          <button style={{ ...S.btn("success"), flex:2, justifyContent:"center", background:saved?"#1a7f3c":undefined, color:saved?"#fff":undefined }} onClick={handleSave}>
  ...
  return (
    <div style={S.modal} onClick={onClose}>
      <div style={{ ...S.modalBox, maxWidth:"420px" }} onClick={e => e.stopPropagation()}>
        {phase === "confirm" && (
          <div>
            <div style={{ fontSize:"18px", fontWeight:"700", color:"#f1f5f9", marginBottom:"4px" }}>Confirmar Cobro</div>
            <div style={{ fontSize:"13px", color:"#64748b", marginBottom:"18px" }}>Se procesara el pago del cliente</div>
            <div style={{ padding:"16px", borderRadius:"12px", background:"rgba(99,102,241,0.08)", border:"1px solid rgba(99,102,241,0.2)", marginBottom:"18px" }}>
              ...
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                <span style={{ fontSize:"14px", color:"#94a3b8", fontWeight:"600" }}>Monto a cobrar</span>
                <span style={{ fontSize:"22px", fontWeight:"800", color:"#4ade80" }}>{fmtUSD(exp.pagoInicial)}</span>
              </div>
            </div>
            <div style={{ display:"flex", gap:"10px" }}>
            ...
            <div style={{ textAlign:"center", marginTop:"10px" }}>
              <button style={{ background:"none", border:"none", color:"#64748b", fontSize:"11px", cursor:"pointer" }} onClick={() => doCharge("rejected")}>Simular rechazo</button>
            </div>
          </div>
        )}
        {phase === "processing" && (
          <div style={{ textAlign:"center", padding:"32px 0" }}>
            ...
            <div style={{ fontSize:"16px", fontWeight:"600", color:"#f1f5f9" }}>Procesando pago...</div>
            <div style={{ fontSize:"13px", color:"#64748b", marginTop:"6px" }}>Conectando con gateway de pagos</div>
          </div>
        )}
        {phase === "result" && (
          <div>
            <div style={{ textAlign:"center", marginBottom:"22px" }}>
              ...
              <div style={{ fontSize:"20px", fontWeight:"700", color:result === "approved" ? "#4ade80" : "#f87171" }}>
  ...
  return (
    <div style={S.modal} onClick={onClose}>
      <div style={{ ...S.modalBox, maxWidth:"440px" }} onClick={e => e.stopPropagation()}>
        <div style={{ fontSize:"18px", fontWeight:"700", color:"#f1f5f9", marginBottom:"4px" }}>Enviar Documentos al Cliente</div>
        <div style={{ fontSize:"13px", color:"#64748b", marginBottom:"18px" }}>El cliente recibira 2 documentos para firmar</div>
        {[
          ...
          <div key={i} style={{ display:"flex", gap:"12px", alignItems:"center", padding:"12px 14px", borderRadius:"10px", background:"#f9fafb", border:"1px solid rgba(255,255,255,0.07)", marginBottom:"8px" }}>
            <div>
              <div style={{ fontSize:"13px", fontWeight:"600", color:"#e2e8f0" }}>{doc.title}</div>
              <div style={{ fontSize:"12px", color:"#64748b" }}>{doc.desc}</div>
            </div>
          </div>
        ))}
        <div style={{ margin:"14px 0", padding:"12px 14px", borderRadius:"10px", background:"#fafbfc", border:"1px solid rgba(255,255,255,0.07)" }}>
          ...
          <div style={{ display:"flex", flexWrap:"wrap", gap:"6px", marginTop:"6px" }}>
            ...
            <span style={S.badge("#60a5fa","rgba(96,165,250,0.08)","rgba(96,165,250,0.25)")}>{exp.tEmail||"sin email"}</span>
          </div>
        </div>
        {phase === "ready"   && <button style={{ ...S.btn("primary"), width:"100%", justifyContent:"center" }} onClick={doSend}>Enviar Documentos Ahora</button>}
        {phase === "sending" && <div style={{ textAlign:"center", padding:"14px", color:"#94a3b8", fontSize:"14px" }}>Enviando...</div>}
        {phase === "sent"    && (
          <div>
            <div style={{ padding:"14px", borderRadius:"10px", textAlign:"center", background:"rgba(74,222,128,0.07)", border:"1px solid rgba(74,222,128,0.2)", marginBottom:"12px" }}>
              <div style={{ fontSize:"14px", fontWeight:"600", color:"#4ade80" }}>Documentos enviados</div>
              <div style={{ fontSize:"12px", color:"#64748b", marginTop:"3px" }}>WhatsApp + Email - En espera de firma</div>
            </div>
...
function FinishModal({ defaultResult, onClose, onFinish }) {
  ...
  return (
    <div style={S.modal} onClick={onClose}>
      <div style={S.modalBox} onClick={e => e.stopPropagation()}>
        <div style={{ fontSize:"18px", fontWeight:"700", color:"#f1f5f9", marginBottom:"18px" }}>Resultado de Verificacion</div>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"10px", marginBottom:"18px" }}>
          {Object.entries(VERIF_RESULTS).map(([key,cfg]) => (
            <div key={key} onClick={() => setResult(key)} style={{ padding:"14px", borderRadius:"12px", cursor:"pointer", border:"2px solid " + (result===key ? cfg.color : "#f0f1f4"), background:result===key ? cfg.bg : "transparent", transition:"all 0.18s" }}>
              <div style={{ fontSize:"13px", fontWeight:"600", color:result===key ? cfg.color : "#64748b" }}>{cfg.label}</div>
            </div>
          ))}
        </div>
        <div style={{ marginBottom:"16px" }}>
...
function UpsalePanel({ exp, onSave }) {
  ...
  return (
    <div style={{ background:"#fafbfc", border:"1px solid rgba(255,255,255,0.07)", borderRadius:"12px", padding:"14px 16px", marginBottom:"16px" }}>
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
        <div style={{ fontSize:"13px", fontWeight:"700", color:"#f1f5f9" }}>Upsale en verificacion</div>
        <button onClick={() => setOpen(o => !o)} style={{ padding:"6px 14px", borderRadius:"8px", cursor:"pointer", fontSize:"12px", fontWeight:"600", background:open?"rgba(99,102,241,0.15)":"#f6f7f9", color:open?"#818cf8":"#94a3b8", border:"1px solid " + (open?"rgba(99,102,241,0.3)":"#eceff3") }}>
          {open ? "Cerrar" : "+ Agregar"}
        </button>
      </div>
        ...
        <div style={{ marginTop:"14px" }}>
          <div style={{ display:"flex", gap:"5px", marginBottom:"14px" }}>
            {[["destino","Destino adicional"],["beneficios","Beneficios extra"]].map(([k,l]) => (
              <button key={k} onClick={() => setUpTab(k)} style={{ padding:"6px 14px", borderRadius:"8px", cursor:"pointer", fontSize:"12px", fontWeight:upTab===k?"700":"400", background:upTab===k?"rgba(99,102,241,0.15)":"transparent", color:upTab===k?"#818cf8":"#64748b", border:upTab===k?"1px solid rgba(99,102,241,0.35)":"1px solid transparent" }}>{l}</button>
            ))}
          </div>
          ...
          {upTab === "destino" && (
            <div>
              <div style={{ ...S.g2, marginBottom:"10px" }}>
                ...
                <div>
                  ...
                  <div style={{ display:"flex", gap:"6px" }}>
                    <button onClick={() => { setDestTipo("qc"); if (destCat) setDestNoches(destCat.qc.noches); }} style={{ flex:1, padding:"8px", borderRadius:"8px", cursor:"pointer", fontSize:"12px", fontWeight:"600", background:destTipo==="qc"?"rgba(99,102,241,0.15)":"#f9fafb", color:destTipo==="qc"?"#818cf8":"#64748b", border:"1px solid " + (destTipo==="qc"?"rgba(99,102,241,0.3)":"#f0f1f4") }}>QC</button>
                    <button onClick={() => { if (destCat && destCat.nq.enabled) { setDestTipo("nq"); setDestNoches(destCat.nq.noches); } }} style={{ flex:1, padding:"8px", borderRadius:"8px", cursor:"pointer", fontSize:"12px", fontWeight:"600", background:destTipo==="nq"?"rgba(74,222,128,0.15)":"#f9fafb", color:destTipo==="nq"?"#4ade80":"#64748b", border:"1px solid " + (destTipo==="nq"?"rgba(74,222,128,0.3)":"#f0f1f4"), opacity:destCat && !destCat.nq.enabled ? 0.3 : 1 }}>NQ</button>
                  </div>
                </div>
              </div>
              <div style={{ ...S.g2, marginBottom:"12px" }}>
                <div>
                  ...
                  <div style={{ display:"flex", gap:"5px" }}>
                    {[3,4,5,6,7].map(n => <button key={n} onClick={() => setDestNoches(n)} style={{ flex:1, padding:"7px", borderRadius:"7px", cursor:"pointer", fontSize:"12px", fontWeight:"600", background:destNoches===n?"rgba(99,102,241,0.15)":"#f9fafb", color:destNoches===n?"#818cf8":"#64748b", border:"1px solid " + (destNoches===n?"rgba(99,102,241,0.3)":"#f0f1f4") }}>{n}</button>)}
                  </div>
                </div>
                <div>
              ...
              <button disabled={!destId||!destPrecio} onClick={handleAddDestino} style={{ width:"100%", padding:"9px", borderRadius:"9px", cursor:"pointer", fontSize:"13px", fontWeight:"700", background:"rgba(99,102,241,0.15)", color:"#818cf8", border:"1px solid rgba(99,102,241,0.3)", opacity:destId&&destPrecio?1:0.4 }}>
            ...
            <div>
                  ...
                  return (
                    <div key={b.id} style={{ borderRadius:"9px", border:"2px solid " + (sel?"rgba(99,102,241,0.45)":"#f0f1f4"), background:sel?"rgba(99,102,241,0.08)":"#fafbfc", overflow:"hidden" }}>
                      <div onClick={() => toggleBenef(b.id)} style={{ padding:"9px 11px", cursor:"pointer", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                        <span style={{ fontSize:"12px", fontWeight:"600", color:sel?"#818cf8":"#94a3b8" }}>{b.label}</span>
                        <span style={{ fontSize:"11px", color:sel?"#818cf8":"#475569", fontWeight:"700" }}>${precio}</span>
                      </div>
                      {sel && (
                        <div style={{ padding:"0 10px 9px", borderTop:"1px solid rgba(255,255,255,0.05)" }}>
                          <div style={{ fontSize:"10px", color:"#64748b", marginBottom:"3px", marginTop:"6px" }}>Precio editable</div>
                          <input type="number" value={precio} onChange={e => setPrecioOvr(p => ({ ...p, [b.id]:e.target.value }))} min="0" style={{ width:"100%", background:"#f6f7f9", border:"1px solid rgba(99,102,241,0.3)", borderRadius:"6px", padding:"5px 9px", color:"#e2e8f0", fontSize:"12px", outline:"none", boxSizing:"border-box" }} />
                        </div>
                      )}
                    </div>
                  );
              ...
              {selBenef.length > 0 && (
                <div style={{ padding:"10px 14px", borderRadius:"9px", background:"rgba(74,222,128,0.06)", border:"1px solid rgba(74,222,128,0.25)", marginBottom:"10px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                  <span style={{ fontSize:"12px", color:"#4ade80" }}>{selBenef.length} beneficio(s) seleccionado(s)</span>
                  <span style={{ fontSize:"14px", fontWeight:"800", color:"#4ade80" }}>+${totalBenef}</span>
                </div>
              )}
              <button disabled={!selBenef.length} onClick={handleAddBeneficios} style={{ width:"100%", padding:"9px", borderRadius:"9px", cursor:"pointer", fontSize:"13px", fontWeight:"700", background:"rgba(74,222,128,0.12)", color:"#4ade80", border:"1px solid rgba(74,222,128,0.3)", opacity:selBenef.length?1:0.4 }}>
...
function SectionPersonal({ exp }) {
  return (
    <div style={S.card}>
      <div style={S.sTitle}>Titular</div>
      <div style={S.g3}>
        <div style={{ gridColumn:"1/3" }}><div style={S.label}>Nombre</div><div style={S.value}>{exp.tFirstName} {exp.tLastName}</div></div>
        <div>
          <div style={S.label}>Fecha nac.</div>
          <div style={S.value}>{exp.tFechaNac ? fmtDate(exp.tFechaNac) : "--"}</div>
          {exp.tFechaNac && <div style={{ fontSize:"11px", color:"#4ade80", fontWeight:"600", marginTop:"2px" }}>{edadLabel(exp.tFechaNac)}</div>}
        </div>
      ...
      {exp.hasPartner && (
        <div>
          ...
          <div style={S.sTitle}>Co-propietario</div>
          <div style={S.g3}>
            <div style={{ gridColumn:"1/3" }}><div style={S.label}>Nombre</div><div style={S.value}>{exp.pFirstName} {exp.pLastName}</div></div>
            <div>
              <div style={S.label}>Fecha nac.</div>
              <div style={S.value}>{exp.pFechaNac ? fmtDate(exp.pFechaNac) : "--"}</div>
              {exp.pFechaNac && <div style={{ fontSize:"11px", color:"#4ade80", fontWeight:"600", marginTop:"2px" }}>{edadLabel(exp.pFechaNac)}</div>}
            </div>
...
function SectionPaquete({ exp, onEdit }) {
  ...
  return (
    <div style={S.card}>
          ...
          return (
            <div key={i} style={{ padding:"10px 14px", borderRadius:"10px", background:"rgba(99,102,241,0.07)", border:"1px solid rgba(99,102,241,0.18)", marginBottom:"6px" }}>
              <div style={{ display:"flex", alignItems:"center", gap:"12px" }}>
                <div style={{ flex:1 }}>
                  <div style={{ fontSize:"14px", fontWeight:"600", color:"#e2e8f0" }}>{cat.nombre}</div>
                  {d.regalo && <div style={{ fontSize:"12px", color:"#fbbf24", marginTop:"2px" }}>Regalo: {d.regalo.label}</div>}
                </div>
                <span style={S.pill(d.tipo==="qc"?"#818cf8":"#4ade80")}>{d.tipo.toUpperCase()} - {d.noches}n</span>
              </div>
            </div>
          );
        })}
      ...
      <div style={S.g3}>
        <div><div style={S.label}>Precio Total</div><div style={{ fontSize:"17px", fontWeight:"800", color:"#4ade80" }}>{fmtUSD(exp.salePrice)}</div></div>
        <div><div style={S.label}>Pago hoy</div><div style={{ fontSize:"17px", fontWeight:"800", color:"#818cf8" }}>{fmtUSD(exp.pagoInicial)}</div></div>
        <div><div style={S.label}>Saldo</div><div style={{ fontSize:"17px", fontWeight:"800", color:"#fbbf24" }}>{fmtUSD(saldo)}</div></div>
      </div>
      {exp.notas && (
        <div style={{ marginTop:"12px", padding:"10px 14px", borderRadius:"9px", background:"#fafbfc", border:"1px solid rgba(255,255,255,0.06)" }}>
          <div style={S.label}>Notas</div>
          <div style={{ fontSize:"13px", color:"#94a3b8", marginTop:"3px" }}>{exp.notas}</div>
        </div>
      )}
    </div>
  );
      ...
      {hasTarjeta ? (
        <div>
          <div style={{ background:"linear-gradient(135deg,#1e1b4b 0%,#312e81 50%,#1e1b4b 100%)", borderRadius:"14px", padding:"20px 22px", marginBottom:"14px", border:"1px solid rgba(129,140,248,0.2)" }}>
            <div style={{ fontSize:"16px", fontWeight:"700", letterSpacing:"0.12em", color:"#e2e8f0", marginBottom:"14px", fontFamily:"monospace" }}>{maskCard(exp.tarjetaNumero)}</div>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-end" }}>
              <div>
                <div style={{ fontSize:"9px", color:"#818cf8", marginBottom:"2px" }}>TITULAR</div>
                <div style={{ fontSize:"13px", fontWeight:"600", color:"#e2e8f0" }}>{exp.tarjetaNombre}</div>
              </div>
              <div style={{ display:"flex", gap:"14px" }}>
                {[["VENCE",exp.tarjetaVence],["TIPO",exp.tarjetaTipo]].map(([l,v]) => (
                  <div key={l}>
                    <div style={{ fontSize:"9px", color:"#818cf8", marginBottom:"2px" }}>{l}</div>
                    <div style={{ fontSize:"12px", fontWeight:"600", color:"#e2e8f0", textTransform:"capitalize" }}>{v}</div>
                  </div>
                ))}
              </div>
            </div>
          </div>
          <div style={{ display:"inline-flex", alignItems:"center", gap:"8px", marginBottom:"14px", padding:"7px 14px", borderRadius:"8px", background:"rgba(251,191,36,0.08)", border:"1px solid rgba(251,191,36,0.2)", cursor:"pointer" }} onClick={() => setShowCVV(p => !p)}>
            <span style={{ fontSize:"12px", color:"#fbbf24" }}>CVV (solo verificador):</span>
            <span style={{ fontSize:"14px", fontWeight:"800", color:"#fbbf24", letterSpacing:"0.2em" }}>{showCVV ? exp.tarjetaCVV : "***"}</span>
            <span style={{ fontSize:"11px", color:"#92400e" }}>{showCVV ? "ocultar" : "ver"}</span>
          </div>
          <div style={{ padding:"8px 12px", borderRadius:"8px", background:"rgba(248,113,113,0.07)", border:"1px solid rgba(248,113,113,0.2)", marginBottom:"14px", fontSize:"11px", color:"#f87171" }}>
        ...
        <div style={{ padding:"12px 14px", borderRadius:"10px", background:"rgba(96,165,250,0.07)", border:"1px solid rgba(96,165,250,0.2)", marginBottom:"14px" }}>
          <div style={{ fontSize:"13px", fontWeight:"600", color:"#60a5fa" }}>Pago por transferencia bancaria</div>
          <div style={{ fontSize:"12px", color:"#64748b", marginTop:"3px" }}>Verificar comprobante antes de procesar</div>
        </div>
      )}
        ...
        <div style={{ marginBottom:"12px" }}>
          ...
          {verif.chargeAttempts.map((a,i) => (
            <div key={i} style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"8px 12px", borderRadius:"8px", marginTop:"6px", background:a.status==="approved"?"rgba(74,222,128,0.05)":"rgba(248,113,113,0.05)", border:"1px solid " + (a.status==="approved"?"rgba(74,222,128,0.2)":"rgba(248,113,113,0.2)") }}>
              <span style={{ fontSize:"12px", color:"#94a3b8" }}>{fmtUSD(a.amount)}</span>
              <span style={{ fontSize:"11px", fontWeight:"700", color:a.status==="approved"?"#4ade80":"#f87171" }}>{a.status==="approved"?"Aprobado":"Rechazado"}</span>
            </div>
          ))}
        </div>
      )}
  ...
  return (
    <div>
      <div style={{ display:"flex", alignItems:"center", gap:"14px", marginBottom:"22px" }}>
        ...
        <div style={{ flex:1 }}>
          <h2 style={{ margin:0, fontSize:"20px", fontWeight:"700", color:"#f1f5f9" }}>{exp.tFirstName} {exp.tLastName}</h2>
          <div style={{ fontSize:"13px", color:"#64748b" }}>Folio {lead.id} - Vendedor: {lead.sellerName} - {fmtDate(lead.createdAt)}</div>
        </div>
        {vr
          ? <span style={S.badge(vr.color,vr.bg,vr.border)}>{vr.label}</span>
          : <span style={S.badge("#fbbf24","rgba(251,191,36,0.08)","rgba(251,191,36,0.2)")}>Pendiente</span>
        }
      </div>

      <div style={{ display:"flex", alignItems:"center", marginBottom:"24px", background:"#fafbfc", border:"1px solid rgba(255,255,255,0.06)", borderRadius:"12px", padding:"16px 24px" }}>
        {steps.map((step,i) => (
          <div key={i} style={{ display:"flex", alignItems:"center", flex:1 }}>
            <div style={{ display:"flex", flexDirection:"column", alignItems:"center", flex:1 }}>
              <div style={{ width:"30px", height:"30px", borderRadius:"50%", display:"flex", alignItems:"center", justifyContent:"center", marginBottom:"5px", fontWeight:"700", fontSize:"13px", background:step.done?"#4ade80":"#f2f3f6", color:step.done?"#052e16":"#475569" }}>
                {step.done ? "v" : i+1}
              </div>
              <div style={{ fontSize:"11px", fontWeight:"600", color:step.done?"#4ade80":"#475569" }}>{step.label}</div>
            </div>
        ...
        <div>
          ...
          {vr && verif && verif.result && (
            <div style={{ ...S.card, border:"1px solid " + vr.border, background:vr.bg }}>
              ...
              {verif.notes && <div style={{ fontSize:"13px", color:"#94a3b8", marginBottom:"10px" }}>{verif.notes}</div>}
              <div style={{ fontSize:"12px", color:"#475569", marginBottom:"10px" }}>Verificado el {fmtDate(verif.verifiedAt)}</div>
              {verif.docsSent && (
                <div style={{ padding:"9px 12px", borderRadius:"9px", background:"rgba(37,211,102,0.06)", border:"1px solid rgba(37,211,102,0.2)", marginBottom:"8px" }}>
                  <div style={{ fontSize:"12px", color:"#4ade80" }}>Documentos enviados - WhatsApp + Email</div>
                </div>
              )}
  ...
  return (
    <div style={{ ...S.card, cursor:"pointer" }} onClick={() => onOpen(lead)}
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:"12px" }}>
        <div>
          <div style={{ fontSize:"16px", fontWeight:"700", color:"#f1f5f9" }}>{exp.tFirstName} {exp.tLastName}</div>
          <div style={{ fontSize:"12px", color:"#64748b", marginTop:"2px" }}>{lead.phone} - {lead.radioName}</div>
          <div style={{ fontSize:"12px", color:"#64748b" }}>{lead.sellerName} - Folio {lead.id}</div>
        </div>
        {vr
          ? <span style={S.badge(vr.color,vr.bg,vr.border)}>{vr.label}</span>
          : <span style={S.badge("#fbbf24","rgba(251,191,36,0.08)","rgba(251,191,36,0.2)")}>Pendiente</span>
      ...
      <div style={S.g3}>
        <div>
          ...
          <div style={{ fontSize:"13px", color:"#cbd5e1" }}>{(exp.destinos||[]).map(d => (DEST_MAP[d.destId]||{}).nombre||d.destId).join(" + ")||"--"}</div>
        </div>
        <div><div style={S.label}>Precio total</div><div style={{ fontSize:"15px", fontWeight:"800", color:"#4ade80" }}>{fmtUSD(exp.salePrice)}</div></div>
        <div><div style={S.label}>Pago hoy</div><div style={{ fontSize:"15px", fontWeight:"800", color:"#818cf8" }}>{fmtUSD(exp.pagoInicial)}</div></div>
      </div>
    </div>
  );
}
...
export default function VerificationModule() {
  ...
  return (
    <div style={S.wrap}>
      <div style={S.topbar}>
        <div style={{ fontSize:"12px", fontWeight:"700", color:"#475569", letterSpacing:"0.12em", textTransform:"uppercase" }}>Mini-Vac CRM</div>
        <div style={{ width:"1px", height:"18px", background:"#eceff3" }} />
        <div style={{ fontSize:"14px", fontWeight:"600", color:"#818cf8" }}>Verificacion</div>
        <div style={{ flex:1 }} />
        {pending.length > 0 && <span style={S.badge("#fbbf24","rgba(251,191,36,0.08)","rgba(251,191,36,0.2)")}>{pending.length} pendiente(s)</span>}
        {ventas.length  > 0 && <span style={S.badge("#4ade80","rgba(74,222,128,0.08)","rgba(74,222,128,0.2)")}>{ventas.length} venta(s) hoy</span>}
      </div>
        ...
        {detail && detailLead ? (
          ...
          <div>
            <div style={{ display:"flex", gap:"12px", marginBottom:"24px", flexWrap:"wrap" }}>
              {[
                { label:"En cola",       val:pending.length,                                                              color:"#fbbf24" },
                { label:"Ventas",        val:ventas.length,                                                               color:"#4ade80" },
                { label:"Rechazadas",    val:done.filter(l => l.verificacion.result==="tarjeta_rechazada").length,        color:"#f87171" },
                { label:"No interesado", val:done.filter(l => l.verificacion.result==="cliente_no_interesado").length,    color:"#94a3b8" },
                { label:"Pend. pago",    val:done.filter(l => l.verificacion.result==="venta_pendiente").length,          color:"#fbbf24" },
              ].map(s => (
                <div key={s.label} style={{ flex:1, minWidth:"110px", padding:"16px 20px", borderRadius:"12px", background:"#f9fafb", border:"1px solid rgba(255,255,255,0.07)" }}>
      ...
      {toast && (
        <div style={{ position:"fixed", bottom:"24px", right:"24px", zIndex:999, padding:"12px 20px", borderRadius:"10px", background:toast.ok?"rgba(74,222,128,0.15)":"rgba(248,113,113,0.15)", border:"1px solid " + (toast.ok?"rgba(74,222,128,0.3)":"rgba(248,113,113,0.3)"), color:toast.ok?"#4ade80":"#f87171", fontSize:"14px", fontWeight:"600", boxShadow:"0 8px 32px rgba(0,0,0,0.4)" }}>
          {toast.msg}
        </div>
      )}
    </div>
