  ...
  const html = `
    ...
    <div style="font-family:Arial,sans-serif;max-width:620px;margin:0 auto;color:#222;">
      ...
      <div style="background:linear-gradient(135deg,#0f2340 0%,#1a3a5c 100%);padding:32px 24px;text-align:center;border-radius:0 0 12px 12px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px;"><tr><td align="center" style="padding:4px 8px;"><a href="tel:18009271490" style="display:inline-block;background:rgba(255,255,255,0.15);border:1px solid rgba(255,255,255,0.3);color:#fff;text-decoration:none;font-size:14px;font-weight:700;padding:10px 20px;border-radius:8px;margin:4px;">📞 1 (800) 927-1490</a> ${lead.chat_url ? `<a href="${lead.chat_url}" style="display:inline-block;background:#38bdf8;color:#0f172a;text-decoration:none;font-size:14px;font-weight:700;padding:10px 20px;border-radius:8px;margin:4px;">💬 Chat en línea</a>` : `<a href="mailto:members@xtravelgroup.com" style="display:inline-block;background:#38bdf8;color:#0f172a;text-decoration:none;font-size:14px;font-weight:700;padding:10px 20px;border-radius:8px;margin:4px;">✉ members@xtravelgroup.com</a>`}</td></tr></table>
